   ...
   <Container className="mt-3">
    ...
    <Col md={4}>
      <Row className="d-flex flex-colum align-items-center">
        <h2>{device.name}</h2>
        <div lassName="d-flex align-items-center justify-content-center" 
        style={{background: `url(${bigStar}) no-repeat center center`, width:240, height: 240, backgroundSize: 'cover', fontSize:64, fontSize:64}}>
          {device.rating}
        </div>
      </Row>
    </Col>
